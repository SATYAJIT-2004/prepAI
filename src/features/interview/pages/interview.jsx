  ...
  if (loading || !report) {
    return (
      <main className="loading-screen">
        <h1>Laoding your requirements...</h1>
      </main>
    );
  }
  ...
  return (
    <div className="interview-page">
      ...
      <div className="mobile-header">
        ...
        <h2 className="mobile-header__title">Interview Plan</h2>
        <div className="mobile-header__placeholder"></div>
      </div>
      ...
      <div className="interview-layout">
        ...
        {/* ── Left Nav ── */}
        <nav
          className={`interview-nav ${mobileMenuOpen ? "interview-nav--mobile-open" : ""}`}
        >
          ...
          <button
            ...
            className="button primary-button nav-download-btn"
          >
            <svg
              height={"0.9rem"}
